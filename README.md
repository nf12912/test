...
This should only be applied to your own work. Once the commit has been pushed (ie. you can see it online) you should not undo, but instead "revert".  
...
* Try to create a pull request that encompasses a set of related changes If it is two seperate features, create two pull requests.  
